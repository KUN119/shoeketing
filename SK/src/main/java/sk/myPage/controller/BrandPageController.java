...
public class BrandPageController {
	...
	public ModelAndView brandInfo(Map<String, Object> map) throws Exception {
		...
		for(int i=0; i<recentGoodsList.size(); i++) {
			...
			// recentGoodsMap에서 TOTAL_GOODS_NUM 꺼내서 int타입의 totalGoodsNum 변수에 저장하고 그 값을 map에 넣어주기 (상품 썸네일 조회해서 가져오기 위해서) 
		...
		for(int i=0; i<rankingGoodsList.size(); i++) {
			...
			// rankingGoodsMap에서 TOTAL_GOODS_NUM 꺼내서 int타입의 totalGoodsNum 변수에 저장하고 그 값을 map2에 넣어주기 (상품 썸네일 조회해서 가져오기 위해서) 
